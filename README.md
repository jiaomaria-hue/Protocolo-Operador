...
### 🎓 Trilha de certificação (meta)

`eJPT` → `BTL1` → `Security+` → `CPTA v2` → `CPTS` → `OSCP`

---

<p align="center"><i>Progresso real, documentado semana a semana — sem inflar número, sem pular etapa.</i></p>