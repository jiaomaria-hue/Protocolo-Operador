...
# 1. Instanciamos a fila
fila = Queue()

# 2. Definimos o 'trabalhador' (o que cada thread fará)
def worker():
    while not fila.empty():
        porta = fila.get()
        # Aqui dentro virá a lógica de teste (socket)
        # fila.task_done() sinaliza que a tarefa terminou
        fila.task_done()

# ... (restante do código com o print do menu)
